...
export default function ProductDetailPage() {
  ...
  // Selection states (removed tailoringOption since it's now handled in sizes)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-6 lg:space-y-8 lg:pt-8">
            ...
            <SizeSelector 
              ...
              customizable={product.Customizable} // Pass the boolean from backend
            />


            {/* Removed TailoringOptions - custom is now handled in SizeSelector */}
